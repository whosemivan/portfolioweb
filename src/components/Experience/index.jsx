        ...
        <section className="experience">
            ...
            <div className="experience__wrapper">
                <div className="experience__item">
                    ...
                    <a className="experience__link" href="https://www.amocrm.ru/">amoCRM</a>
                    <span className="experience__date">dec 2023 - present</span>
                    <p className="experience__text">
                        I work as a frontend developer in the integration development team at amoCRM / Kommo.
                    </p>
                </div>
                <div className="experience__item">
                    <h3 className="experience__item-title">frontend developer</h3>
