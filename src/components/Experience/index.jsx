        ...
        <section className="experience">
            ...
            <div className="experience__wrapper">
                <div className="experience__item">
                    ...
                    <a className="experience__link" href="https://kwork.ru/user/semivan">freelance</a>
                    <span className="experience__date">may 2021 - present</span>
                    <p className="experience__text">
                        i worked as a freelancer. successfully completed several orders, you can see it in the <Link className="experience__link-text" to='/portfolio'>portfolio</Link>. <a target="_target" className="experience__link-text" href="https://kwork.ru/user/semivan">my kwork.</a>
                    </p>
                </div>
                <div className="experience__item">
                    <h3 className="experience__item-title">frontend developer</h3>
                    ...
                    <span className="experience__date">nov 2022 - now</span>
                    <p className="experience__text">
                        i work as a frontend developer at calendarStorm startup. we work as a team with a product manager, a team leader and a backend developer.
                    </p>
                </div>
                <div className="experience__item">
